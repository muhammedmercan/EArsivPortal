...
import com.example.e_arsivportal.presentation.webview.WebViewActivity
...
class OutgoingInvoicesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.outgoingInvoicesPageShimmer.startShimmerAnimation()
    ...
    fun observeLiveData() {
        ...
        viewModel.loading.observe(this, Observer {
            ...
            if (it == false) {
                binding.outgoingInvoicesPageShimmer.stopShimmerAnimation()
                binding.outgoingInvoicesPageShimmer.visibility = View.GONE
            }

            else {
                binding.outgoingInvoicesPageShimmer.startShimmerAnimation()
                binding.outgoingInvoicesPageShimmer.visibility = View.VISIBLE
            }
